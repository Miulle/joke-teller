...
function jokeToSpeech(jokeText) {
    VoiceRSS.speech({
        key: 'a7d531d536994fdebd6d69e4da8d58b8',
        src: jokeText,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
async function getJokes() {
    let joke = '';
    const apiUrl = 'https://sv443.net/jokeapi/v2/joke/Miscellaneous,Christmas?blacklistFlags=nsfw,religious,political,racist,sexist';
    try {
